def validate_One_Zero_account(account_number: str, branch_number: str):
    ...
    # Last two digits of account number is the review literature number.
    # The formula is;
    ...
    # Create a variable that holds the check digitץ
    ...
    if review_literature == SUBTRACT_AFTER_MODULUS_RESULT - res_after_mod_97:
        return True
    else:
        return False
